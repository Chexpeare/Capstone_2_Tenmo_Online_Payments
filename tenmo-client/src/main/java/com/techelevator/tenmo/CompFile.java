...
//        App_Test app = new App_Test(new ConsoleService(System.in, System.out), new AuthenticationService(API_BASE_URL), new AuthenticationService(API_BASE_URL));
//        app.run();
//    }
//
//    public App_Test(ConsoleService console, AuthenticationService authenticationService, AuthenticationService tenmoService) {
...
//                            if (transferAmount.compareTo(new BigDecimal(0)) == 1 && balance.getBalance(currentUser.getToken()).compareTo(transferAmount)  >= 0) {
